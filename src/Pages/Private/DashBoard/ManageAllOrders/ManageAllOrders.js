    ...
    return (
        <Container>
            ...
            <TableContainer component={Paper}>
                <Table style={allProducts} sx={{color:'#002426', minWidth: 650 }} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell style={cellStyle} align="right">Delete</TableCell>
                        </TableRow>
                        {boughtItems.map((boughtItem) => (
                            ...
                            >
                                ...
                                <TableCell style={cellStyle} align="right"><Button style={buttonStyle} onClick={() => handleDelete(boughtItem._id)}>Remove</Button></TableCell>
                            </TableRow>
                        ))}
                    </TableHead>
                </Table>
